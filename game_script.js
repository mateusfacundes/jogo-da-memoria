let cards = {
    1: {
        1: { text: "População: Se há 100 alunos em uma escola... ", matched: false, pairId: 31 },
        31: { text: "*A população é 100", matched: false, pairId: 1 },

        2: { text: "Amostra: Se selecionarmos aleatoriamente 20 alunos da escola para uma pesquisa... ", matched: false, pairId: 32 },
        32: { text: "*A amostra é 20", matched: false, pairId: 2 },

        3: { text: "Variável: Se estamos medindo a altura dos alunos... ", matched: false, pairId: 33 },
        33: { text: "*A variável é a altura", matched: false, pairId: 3 },

        4: { text: "Dados: Se registramos as alturas dos 20 alunos selecionados: 160 cm, 165 cm, 170 cm, ...", matched: false, pairId: 34 },
        34: { text: "*Os dados seriam as alturas registradas", matched: false, pairId: 4 },

        5: { text: "Tipo de Dados: Se classificamos os alunos em categorias de gênero (masculino/feminino)...", matched: false, pairId: 35 },
        35: { text: "*É um tipo de dado qualitativo", matched: false, pairId: 5 },

        6: { text: "Frequência: Se contamos quantos alunos têm uma altura de 170 cm na amostra e são 3... ", matched: false, pairId: 36 },
        36: { text: "*A frequência é 3", matched: false, pairId: 6 },
    },
    2: {
        7: { text: "Distribuição de Frequência: Se ...", matched: false, pairId: 37 },
        ...
        8: { text: "Média: Se calculamos a média...", matched: false, pairId: 38 },
        38: { text: "*A média das alturas dos alunos na amostra é (160 + 165 + 170 + ...) / 20", matched: false, pairId: 8 },

        9: { text: "Mediana: Se organizamos as alturas em ordem crescente e selecionamos a altura do meio... ", matched: false, pairId: 39 },
